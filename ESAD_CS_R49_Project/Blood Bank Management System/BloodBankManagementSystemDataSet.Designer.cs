...
namespace Blood_Bank_Management_System {
    ...
    public partial class BloodBankManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class newDonorDataTable : global::System.Data.TypedTableBase<newDonorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public newDonorRow AddnewDonorRow(string name, string fName, string mName, string dob, long phone, string email, string bloodgroup, string address, string gender, byte[] picture) {
        ...
        public partial class newDonorRow : global::System.Data.DataRow {
            ...
            public long phone {
                get {
                    return ((long)(this[this.tablenewDonor.phoneColumn]));
                }
                set {
...
namespace Blood_Bank_Management_System.BloodBankManagementSystemDataSetTableAdapters {
    ...
    public partial class newDonorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[newDonor] WHERE (([dID] = @Original_dID) AND ([name] = @Original_name) AND ([fName] = @Original_fName) AND ([mName] = @Original_mName) AND ([dob] = @Original_dob) AND ([phone] = @Original_phone) AND ([email] = @Original_email) AND ([bloodgroup] = @Original_bloodgroup) AND ([address] = @Original_address) AND ([gender] = @Original_gender))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[newDonor] ([name], [fName], [mName], [dob], [phone], [email], [bloodgroup], [address], [gender], [picture]) VALUES (@name, @fName, @mName, @dob, @phone, @email, @bloodgroup, @address, @gender, @picture);
SELECT dID, name, fName, mName, dob, phone, email, bloodgroup, address, gender, picture FROM newDonor WHERE (dID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[newDonor] SET [name] = @name, [fName] = @fName, [mName] = @mName, [dob] = @dob, [phone] = @phone, [email] = @email, [bloodgroup] = @bloodgroup, [address] = @address, [gender] = @gender, [picture] = @picture WHERE (([dID] = @Original_dID) AND ([name] = @Original_name) AND ([fName] = @Original_fName) AND ([mName] = @Original_mName) AND ([dob] = @Original_dob) AND ([phone] = @Original_phone) AND ([email] = @Original_email) AND ([bloodgroup] = @Original_bloodgroup) AND ([address] = @Original_address) AND ([gender] = @Original_gender));
SELECT dID, name, fName, mName, dob, phone, email, bloodgroup, address, gender, picture FROM newDonor WHERE (dID = @dID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Blood_Bank_Management_System.Properties.Settings.Default.BloodBankManagementSystemCon;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT dID, name, fName, mName, dob, phone, email, bloodgroup, address, gender, p" +
                "icture FROM dbo.newDonor";
        ...
        public virtual int Fill(BloodBankManagementSystemDataSet.newDonorDataTable dataTable) {
        ...
        public virtual BloodBankManagementSystemDataSet.newDonorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BloodBankManagementSystemDataSet.newDonorDataTable dataTable = new BloodBankManagementSystemDataSet.newDonorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BloodBankManagementSystemDataSet.newDonorDataTable dataTable) {
        ...
        public virtual int Delete(int Original_dID, string Original_name, string Original_fName, string Original_mName, string Original_dob, long Original_phone, string Original_email, string Original_bloodgroup, string Original_address, string Original_gender) {
        ...
        public virtual int Insert(string name, string fName, string mName, string dob, long phone, string email, string bloodgroup, string address, string gender, byte[] picture) {
            if ((name == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_address, 
                    string Original_gender) {
            return this.Update(name, fName, mName, dob, phone, email, bloodgroup, address, gender, picture, Original_dID, Original_name, Original_fName, Original_mName, Original_dob, Original_phone, Original_email, Original_bloodgroup, Original_address, Original_gender, Original_dID);
        }
    }
